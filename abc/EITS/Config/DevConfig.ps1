    ...
    Node "localhost"
    {
        ...
        Script Install_Ccmsetup
        {
            ...
            SetScript = { 
                ...
                $proc = Start-Process -FilePath "C:\ccmsetup\CCMSetup.exe" -ArgumentList "/mp:SVRSCCM1P001.ABC.amerisourcebergen.com SMSSITECODE=ABC FSP=SVRSCCM1P001 SMSSLP=SVRSCCM1P001 dnssuffix=abc.amerisourcebergen.com resetkeyinformation=true" -PassThru -Wait
